...
#'
#' @description Blood alcohol concentration of drivers involved in fatal
#' accidents that occurred in the USA, during the year of 2019.
#'
#' @format A numeric vector with 2,495 blood alcohol concentrations, expressed in
#' grams/100 ml, with three decimal places.
#'
#' @source
...
#' Administration Department of Transportation (\url{https://www.nhtsa.dot.gov}).
#' It is part of The Fatality Analysis Reporting System (FARS).
#'
...
#' Manual (available
#' \href{https://crashstats.nhtsa.dot.gov/Api/Public/ViewPublication/813010}{here})
