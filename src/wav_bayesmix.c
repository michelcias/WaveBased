 ...
 */
static void WBDrawComponent(const double *y, const int *z, int n, int grp,
 ...
 *          the stream of the sampler independent of the data.
 *
 * @param[in]  y     Observed values of length n.
 ...
 */
static void WBDrawAlloc(const double *y, const double *alpha, int n,
